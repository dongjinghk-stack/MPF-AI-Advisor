...
const FundTransferView: React.FC<FundTransferViewProps> = ({ scenario, onReset }) => {
  if (!scenario) {
    return (
    ...
    <div className="max-w-4xl mx-auto animate-fade-in space-y-8">
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200 relative">
        ...
        <div className="mt-8 pt-6 border-t border-gray-100 flex flex-col sm:flex-row gap-4 justify-end">
           ...
           <button className="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg shadow-blue-200 transition-all transform hover:-translate-y-0.5">
             Confirm Transfer
           </button>
        </div>
      </div>
